...
export default function HomeHeroSection() {
    return (
        <section className="relative py-20 md:py-32 px-4 bg-primary">
            <Image src={ASSET_URL['group_donation']} alt='group_donation' className='object-cover opacity-70 overlay' fill />
            <div className="container mx-auto relative flex flex-col justify-center items-center gap-2 py-10 backdrop-blur-sm">
                ...
                <h1 style={{ textShadow: "0 0 10px #0005" }} className="text-4xl lg:text-6xl text-center text-white font-bold font-grotesk max-w-3xl">We are committed to a better life for the girl child</h1>
