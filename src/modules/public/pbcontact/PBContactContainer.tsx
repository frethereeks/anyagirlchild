    ...
    <main className='flex flex-col'>
      ...
      <section className="relative flex flex-col justify-center py-20 px-4">
        <div className="container mx-auto relative flex flex-col md:flex-row justify-center gap-4">
          ...
          <Link href={`mailto:anyagirlchildfoundation@gmail.com`} className="flex-1 leading-loose flex items-center gap-3 text-text">
            <span className="h-10 w-10 rounded-md text-lg md:text-2xl text-white bg-secondary flex-shrink-0 grid place-items-center"><LuMessageSquare /></span> anyagirlchildfoundation@gmail.com
          </Link>
