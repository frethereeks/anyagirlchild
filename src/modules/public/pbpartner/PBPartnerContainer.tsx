...
return (
    <section className="container mx-auto pb-12 px-4 md:px-16 bg-gray-50">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">
            Join the Movement
        </h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Together, we can change lives. Become a volunteer or a partner today and help empower the girl child.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Volunteer Section */}
            <div className="bg-white shadow-lg shadow-text/20 rounded-lg p-6 flex flex-col items-center text-center">
        ...
        {/* Modal */}
        <Modal
            title={`Join as ${selectedType === "Volunteer" ? "Volunteer" : "Partner"}`}
            open={open}
