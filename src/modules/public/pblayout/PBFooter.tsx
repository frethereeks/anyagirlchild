    ...
    <footer className='relative bg-primary pt-10 pb-4 px-4'>
      ...
      <div className="container mx-auto relative z-20 grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-10 py-10 rounded-md text-white">
        <aside className="flex flex-col sm:justify-center gap-4">
          <h2 className="text-white text-2xl font-bold md:text-left">AnyaGirlChild</h2>
          <h2 className="text-white text-2xl font-bold md:text-left uppercase">Foundation</h2>
          <p className="text-lg lg:text-xl text-text font-medium mb-5 leading-none truncate line-clamp-2 whitespace-pre-wrap">Her Future, our Priority</p>
        </aside>
        <aside className="flex flex-col sm:justify-center gap-4">
